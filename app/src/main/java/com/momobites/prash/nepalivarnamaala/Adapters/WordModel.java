...
public class WordModel {
     ...
     */
    public WordModel(int defaultTranslationId, int nepaliTranslationId, int devnagariResourceId, int audioResourceId) {
     ...
     * @param audioResourceId is the resource ID for the audio file associated with this word
     */
    public WordModel(int defaultTranslationId, int nepaliTranslationId, int devnagariResourceId, int imageResourceId,
                     int audioResourceId) {
        mDefaultTranslationId = defaultTranslationId;
        mNepaliTranslationId = nepaliTranslationId;
        mDevnagariiD = devnagariResourceId;
