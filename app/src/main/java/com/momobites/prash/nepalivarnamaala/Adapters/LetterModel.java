...
public class LetterModel {
     ...
     */
    public LetterModel(int nepaliTranslationId, int devnagariResourceId, int audioResourceId) {
     ...
     * @param audioResourceId is the resource ID for the audio file associated with this word
     */
    public LetterModel(int nepaliTranslationId, int devnagariResourceId, int imageResourceId,
                       int audioResourceId) {
